  ...
  return (
    <footer className="border-t bg-background/80 backdrop-blur-lg relative overflow-hidden">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-1">
            <Link href="/">
              <Image src="/logo(1).png" alt="Prospeera Logo" width={180} height={48} className="mix-blend-color-burn dark:mix-blend-lighten" />
            </Link>
      ...
      <div className="w-full text-center py-4">
        <span className="font-headline text-[16rem] font-black text-foreground/5 leading-none select-none tracking-tighter transition-colors hover:text-primary">
            PROSPEERA
        </span>
      </div>
    </footer>
