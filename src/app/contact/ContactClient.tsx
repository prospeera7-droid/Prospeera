            ...
            <Card className="h-full bg-background/20 backdrop-blur-sm shadow-xl transition-all duration-300">
              ...
              <CardContent className="space-y-6 pt-2">
                <div className="flex items-center gap-4">
                  ...
                  <a href="mailto:hello@prospeera.com" className="hover:underline">info@prospeera.com</a>
                </div>
                <div className="flex items-center gap-4">
                  <Phone className="h-6 w-6 text-muted-foreground" />
                  <span>+91 7046292214</span>
                </div>
                <div className="flex items-start gap-4">
                  <MapPin className="h-6 w-6 text-muted-foreground mt-1" />
                  <div>
                    <p className="font-bold">Prospeera Ahmedabad</p>
                    <p>I-202 ShreeDhar Sparsh, Ahmedabad, Gujarat, India-382418</p>
                  </div>
                </div>
              </CardContent>
            </Card>
